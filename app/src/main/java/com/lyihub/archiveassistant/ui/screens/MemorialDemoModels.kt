...
internal val pendingMemorialSummaries: List<PendingMemorialSummary> = listOf(
...
internal val memorialPages: List<MemorialPage> = listOf(
...
internal val directoryItems: List<DirectoryItem> = listOf(
    DirectoryItem(
        title = "江南水患赈灾折",
        meta = "工部侍郎 · 三日前",
